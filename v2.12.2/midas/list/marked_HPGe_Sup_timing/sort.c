...
int main(int argc, char *argv[])
{
  ...
  printf("Program sorts HPGe CC to BGO suppresor timing based on triggers marked on the list of fragments created from GRIF3/GRIF4 midas file.\n");
  ...
  if((out=fopen("HPGe_CC_Sup_timing.mca","w"))==NULL)
    {

...
int main(int argc, char *argv[])
{
  ...
  if(argc!=3)
    {
      printf("list_marked_HPGe_CC_timing fragment_list map\n");
      exit(-1);
    }
  
 
  printf("Program sorts HPGe CC to CC timing based on triggers marked on the list of fragments created from GRIF3/GRIF4 midas file.\n");
  ...
  if((out=fopen("HPGe_CC_timing.mca","w"))==NULL)
    {

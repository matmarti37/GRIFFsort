...
int analyze_fragment(Grif_event* ptr,short* waveform)
{
 ...
 long long time=(ptr->timestamp)&(~0x3ffff);
 time*=10;
 long long cfd=ptr->cfd;
 cfd*=10;
 cfd/=16;
 time+=cfd;
 ...
 FILE *outputfile; outputfile=fopen(output_filename,"a");

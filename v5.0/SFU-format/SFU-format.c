...
void display_caheader(caheader* d)
{
  ...
  printf("CFD        fold                   %4.4x\n",d->Tfold);
  printf("Time Stamp fold                   %4.4x\n",d->TSfold);  
  printf("Energy hit pattern                %12.12lx\n",d->EHP[0]);
  printf("CFD hit pattern                   %12.12lx\n",d->THP[0]);
  printf("Time Stamp hit pattern            %12.12lx\n",d->TSHP[0]);

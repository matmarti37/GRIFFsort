...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("sfu_check_CsIFold2D SFU_data_file detector_subsystem_x detector_subsystem_y\n");
  ...
  if((cluster=fopen(name->fname.cluster_file,"r"))==0)
    {
      printf("ERROR in opening cluster file\n");
      exit(EXIT_FAILURE);
    }

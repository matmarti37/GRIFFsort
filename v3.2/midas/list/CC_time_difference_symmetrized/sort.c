...
int main(int argc, char *argv[])
{
  ...
  if(argc!=4)
    {
      printf("list_CC_sym_time_difference list_input_data map window_[ns]\n");
      exit(-1);
    }
  
 
  printf("Program sorts time difference histogram between CC fragments within a time window on the list\n");
  ...
  if((output=fopen("CC_dt.mca","w"))==NULL)
    {

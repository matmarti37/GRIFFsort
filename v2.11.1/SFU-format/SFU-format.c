...
{
  printf(" %4d     %8.8x  %8.8x  %8.8x  %8.8x ",i,d->timestamp_up&0x00ffffff,d->timestamp&0x00ffffff,d->cfd,d->charge);  
}
/*===============================================================*/
...
{
  printf("Segment    TS_high   TS low     CFD      Charge     T0\n");
}
/*===============================================================*/
void display_suppressor_legend()
{
  printf("Suppressor TS_high   TS low     CFD      Charge     T0\n");
}
/*===============================================================*/

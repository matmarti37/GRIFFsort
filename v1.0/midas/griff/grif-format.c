...
unsigned* grif_fragment;  unsigned grif_fragment_len;
int unpack_grif3_bank(unsigned *evntbuf, int length, Grif_event *evptr, int process_waveforms, short* waveform)
{
   unsigned *evntbufend = evntbuf+length;
